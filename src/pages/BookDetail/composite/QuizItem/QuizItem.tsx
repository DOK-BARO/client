		...
		<div className={styles["container"]}>
			<div className={styles["content"]}>
				<div className={styles["header"]}>
					...
					<div className={styles["quiz-level"]}>
						<QuizLevelBarChart level={Math.round(quiz.averageDifficultyLevel)} width={24} height={24} />
				...
				<Button
					...
					size="xsmall" color="secondary">{quiz.questionCount} 문제</Button>
			</div>
			<div className={styles["footer"]}>
				...
				<Button
					size="small"
					color="primary"
					className={styles["take-quiz-button"]} onClick={goToPlayQuiz}>
					풀기
				</Button>
			</div>
		</div>
